    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-submenu {{ (request()->is('master/*')) ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                ...
                <li class="menu-section">
                    <h4 class="menu-text">Perpustakaan</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                <li class="menu-item menu-item-submenu {{ (request()->is('transaksi/*')) ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
										<span class="svg-icon menu-icon">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (request()->is('transaksi/pengembalian')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="/transaksi/pengembalian" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                ...
                <li class="menu-item menu-item-submenu {{ (request()->is('manajemen/*')) ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item {{ (request()->is('manajemen/stock')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="/manajemen/stock" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
                            ...
                            <li class="menu-item {{ (request()->is('manajemen/inventaris')) ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                <a href="/manajemen/inventaris" class="menu-link">
                                    <i class="menu-bullet menu-bullet-dot">
                                        <span></span>
                                    </i>
