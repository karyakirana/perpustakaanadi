                ...
                <div class="col-lg-12">
                    <table class="table-bordered table row-col-divider table-responsive-lg">
                        <tr>
                            ...
                            <th class="text-center italic" >Kode Peminjam</th>
                        ...
                        @forelse($datapeminjaman_buku as $row)
                            <tr>
                                <td class="text-center italic" >{{$row->kode_peminjaman}}</td>
