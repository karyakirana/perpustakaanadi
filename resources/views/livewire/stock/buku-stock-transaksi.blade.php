    ...
    <div>
        <div>
            ...
            <x-mikro.card-custom :title="'Buku Stock'">
                <x-slot name="toolbar">
                ...
                <div class="row">
                    <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-4 col-form-label ml-3">Tujuan</label>
                                        <div class="col-7">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-4 col-form-label ml-3">Tgl Perubahan</label>
                                        <div class="col-7">
                                            <x-nano.input-datepicker :hasError="$errors->has('tglPerubahan')"
                                                                     wire:model.defer="tglPerubahan"
                                                                     id="tglPerubahan"/>
                                            @error('tglPerubahan')
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                            @forelse($detailStock as $index => $item)
                                <tr>
            ...
            @push('scripts')
                <script>
                    $('#tglPerubahan').on('change', (e)=>{
                        let date = $(this).data('#tglPerubahan')
                    @this.tglPerubahan = e.target.value;
                    })
                </script>
            @endpush
        </div>
